...
def get_tianchi_train_dataset():
    ...
    if machine_name == "P100v0":
        ...
        # dataset_dir='/home/sk49/workspace/dataset/ailiKeypoint/train'
        # ann_path='/home/sk49/workspace/dataset/ailiKeypoint/train/Annotations/merge.csv'
